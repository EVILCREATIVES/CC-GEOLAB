...
function LogsTab({ token }: { token: string }) {
  ...
  return (
    <div style={{ ...styles.tableWrap, maxHeight: "55vh", overflowY: "auto" }}>
  ...
  return (
    <div>
      <p style={{ color: "var(--muted)", fontSize: 13, margin: "0 0 8px" }}>
        ...
        These examples are injected into the system prompt as few-shot training and used by report generation.
      </p>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  overlayCard: {
    ...
    border: "1px solid rgba(137,168,201,0.28)",
    borderRadius: 12,
    padding: 24,
  },
  page: {
